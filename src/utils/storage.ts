...
export const cleanInitialRevenues: RevenueItem[] = [
  {
    ...
    calculatedAmount: 0,
    isCustomRate: false,
    note: 'เงินอุดหนุนรายหัวตามเกณฑ์ สพฐ.',
  },
  {
    id: 2,
    schoolId: 1,
    fiscalYearId: 1,
    category: 'activity',
    itemName: 'เงินกิจกรรมพัฒนาผู้เรียน',
    ratePerHead: 460,
    eligibleCount: 0,
    calculatedAmount: 0,
    isCustomRate: false,
...
export const cleanInitialLearnerActivities: LearnerActivity[] = [
  {
    ...
    schoolId: 1,
    fiscalYearId: 1,
    activityName: 'กิจกรรมวิชาการ',
    percentage: 20,
    allocatedAmount: 0,
    spentAmount: 0,
    remainingAmount: 0,
    note: 'ค่ายวิชาการ เสริมทักษะ และแก้ปัญหาการเรียน',
  },
  {
    id: 2,
    schoolId: 1,
    fiscalYearId: 1,
    activityName: 'กิจกรรมคุณธรรม จริยธรรม และลูกเสือ/เนตรนารี',
    percentage: 20,
    allocatedAmount: 0,
    spentAmount: 0,
    remainingAmount: 0,
    note: 'จิตอาสา พัฒนาคุณลักษณะ และเข้าค่ายพักแรม',
  },
  {
    id: 3,
    schoolId: 1,
    fiscalYearId: 1,
    activityName: 'กิจกรรมทัศนศึกษา',
    percentage: 20,
    allocatedAmount: 0,
    spentAmount: 0,
    remainingAmount: 0,
    note: 'เรียนรู้นอกสถานที่และแหล่งเรียนรู้จริง',
  },
  {
    id: 4,
    schoolId: 1,
    fiscalYearId: 1,
    activityName: 'กิจกรรมบริการ ICT',
    percentage: 20,
    allocatedAmount: 0,
    spentAmount: 0,
    remainingAmount: 0,
    note: 'ส่งเสริมการเรียนรู้เทคโนโลยีสารสนเทศสำหรับนักเรียน',
  },
  {
    id: 5,
    schoolId: 1,
    fiscalYearId: 1,
    activityName: 'กิจกรรมกรณีสถานการณ์ฉุกเฉิน/โรคอุบัติใหม่',
    percentage: 20,
    allocatedAmount: 0,
    spentAmount: 0,
    remainingAmount: 0,
    note: 'การเรียนทางไกลหรือแก้ปัญหาในภาวะวิกฤต',
  },
];
